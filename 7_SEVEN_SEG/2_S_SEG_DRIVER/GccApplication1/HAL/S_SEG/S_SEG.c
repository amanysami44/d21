...
void S_SEG_DISPLAY     (uint8 full_number)
{
	uint8 i;
	for(i=0;i<100;i++)
	{
		uint8 l_part = (full_number / 10);
		uint8 r_part = (full_number % 10);
...
void S_SEG_COUNT_DOWN  (sint8 full_number)
{
...
void S_SEG_TIMER       (uint8 full_number)
{
	uint16 j;
